...
/* 
customerDatabase is an object with the property customers
customers is an array of unnamed objects
each unnamed object has the property contacts
contacts is an object with the property email
email is an array

I need to get the contents of the email array for each element in customers and send those elements to a single array

End goal: emailArray[] with all emails in it
*/

// 1. Define email array
let emailArray = [];


// 2. Get customers array from customerDatabase
const customerArray = customerDatabase.customers;


/* 
3. For each element in customers array:
  a. Return the array of emails
  b. Concat that variable to the email array
*/
const getEmails = (customerObject) => {
  const customerEmails = customerObject.contacts.email;
  emailArray = emailArray.concat(customerEmails);
  // console.log(emailArray);
}
customerArray.forEach(getEmails);


// 4. Console.log the email array
emailArray.forEach((element) => console.log(element));